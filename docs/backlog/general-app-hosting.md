...
> scaffolds (dash/static/python/node/flask/fastapi/rust/react/svelte/vue/streamlit/gradio) are in the runner, and the **non-Dash proof now exists**:
...
> template hardening beyond the first React/Svelte/Vue/Flask/FastAPI/Rust/Streamlit/Gradio scaffolds, heavier Docker/Compose
...
flask / fastapi / rust / react / svelte / vue / streamlit / gradio), each emitting a directory + the right `mount`
