...
- [**ot-hmi-demo**](ot-hmi-demo.md) — scaffolded in `../curiator-ot` as the OT / HMI-maintenance
...
- [**math-geometry-collection**](math-geometry-collection.md) — scaffolded in `../curiator-geometry` as
