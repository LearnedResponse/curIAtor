...
- [**games-collection**](games-collection.md) — local draft-table proof and seeded feedback round are
  closed; next local tranche is engine-backed overlay shape before external dr4ft/import or licensed-engine work.
