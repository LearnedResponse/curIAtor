...
commits, as generated by `curiator stats compare` on curIAtor 0.2.0 at runner commit `55c4ee6`.
Same-machine fresh-clone preflight passes for the three required public collections and two optional
public-shaped collections. The Zenodo DOI is assigned during the tagged GitHub-to-Zenodo publication
step and is therefore recorded as pending in this snapshot rather than asserted in advance.
...
_Runner: curIAtor 0.2.0, `main@55c4ee6`, clean._
...
primary entry points. The exact runner snapshot used for this manuscript is `main@55c4ee6`. Zenodo DOI
assignment is pending the tagged GitHub-to-Zenodo archive step; once assigned, `CITATION.cff` and this
section should be refreshed with the concept DOI and version DOI.
